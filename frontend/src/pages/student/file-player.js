    ...
    <style>
      * {
      ...
      .logout-modal-confirm {
        background: color-mix(in srgb, #7ea2d4 25%, transparent);
        color: #7ea2d4;
        border-color: color-mix(in srgb, #7ea2d4 45%, transparent);
      }

      .logout-modal-confirm:hover {
        background: color-mix(in srgb, #7ea2d4 35%, transparent);
      }
