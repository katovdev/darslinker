...
// Initialize lesson player page (new version for course-learning)
export async function initLessonPlayerPage(courseId, lessonId) {
  console.log('📹 Loading lesson player for course:', courseId, 'lesson:', lessonId);
...
function renderLessonViewPage(courseData, currentLesson) {
  ...
  const themeColor = '#7ea2d4'; // Always use project color
  const logoText = 'darslinker';
        ...
        <div class="lesson-view-container">
          <div class="lesson-view-header-content">
            <div class="lesson-view-logo">
              <div class="lesson-view-logo-text">dars<span style="color: #7ea2d4;">linker</span></div>
            </div>
